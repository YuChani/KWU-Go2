...
def generate_launch_description():
    ...
    # default_world_path = os.path.join(config_pkg_share, "worlds/gcamp_world.world")
    default_world_path = os.path.join(config_pkg_share, "worlds/maze_1_6x5.world")
    # default_world_path = os.path.join(config_pkg_share, "worlds/maze_4_metal_6x6.world")
    # default_world_path = os.path.join(config_pkg_share, "worlds/industrial-warehouse.world")
    ...
    # maze map 전용 스폰
    # declare_world_init_heading = DeclareLaunchArgument("world_init_heading", default_value="3.14159")
    ...
    sleep_before_spawn = ExecuteProcess(
            cmd=['sleep', '3'],
            shell=True
    )
